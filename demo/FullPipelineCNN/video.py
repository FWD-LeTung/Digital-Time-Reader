...
from model.Reader.cnn.ocrcnn import OCRCNN
# ================= CONFIG =================
...
# 2. Hàm hỗ trợ xử lý cắt 4 chữ số (Dựa trên logic split4.py)
        ...
        if r.keypoints is not None and r.boxes is not None:
            ...
            for obj_id, pts in enumerate(kpts_xy):
                ...
                if digits and len(digits) == 4:
                    ...
                    # --- HIỂN THỊ: Chỉ vẽ text thời gian, KHÔNG vẽ Bounding Box ---
                    # Lấy tọa độ điểm đầu tiên để đặt text cho gần đối tượng
