...
from model.Reader.crnn.ocrcrnn import OCRCRNNgray, TinyCRNN

# ================= CONFIG =================
YOLO_MODEL_PATH = "../../model/bestDetect131.pt"
OCR_MODEL_PATH = "../../model/Reader/crnn/crnn_GRU.pth"
VIDEO_PATH = "C:/Users/Admin.ADMIN-PC/Downloads/WIN_20260106_13_48_36_Pro.mp4"
...
ocr_model = TinyCRNN(NUM_CLASSES=len(CHARS) + 1).to(DEVICE)
